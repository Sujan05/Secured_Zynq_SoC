...
HD_PWD='/home/ssaha/Vivado_projects/Secured_SoC/Secured_SoC.runs/design_1_RSACypher_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_RSACypher_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_RSACypher_0_0.tcl
