...
HD_PWD='/home/ssaha/Vivado_projects/SoC_4IP/SoC_4IP.runs/design_1_Median_Filter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Median_Filter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Median_Filter_0_0.tcl
